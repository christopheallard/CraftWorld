...
minetest.register_alias("mapgen_dirt_with_grass", "cw_core:dirt_with_grass")
...
if minetest.settings:get_bool("devtest_v6_mapgen_aliases", false) then
	...
	minetest.register_alias("mapgen_dirt_with_snow", "cw_core:dirt_with_snow")
	...
	minetest.register_alias("mapgen_junglegrass", "cw_core:junglegrass")
